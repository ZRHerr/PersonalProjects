...
namespace QuickFix.Database.Migrations
{
    ...
    [Migration("20191011211332_InitialArchitecture")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuickFix.Domain.UserEntity", b =>
                {
            ...
            modelBuilder.Entity("QuickFix.Domain.UserLogEntity", b =>
                {
            ...
            modelBuilder.Entity("QuickFix.Domain.UserEntity", b =>
                {
                    b.OwnsOne("QuickFix.Domain.Email", "Email", b1 =>
                        {
                    ...
                    b.OwnsOne("QuickFix.Domain.FullName", "FullName", b1 =>
                        {
                            b1.Property<long>("UserEntityUserId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint")
                    ...
                    b.OwnsOne("QuickFix.Domain.SignIn", "SignIn", b1 =>
                        {
                            b1.Property<long>("UserEntityUserId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint")
            ...
            modelBuilder.Entity("QuickFix.Domain.UserLogEntity", b =>
                {
                    b.HasOne("QuickFix.Domain.UserEntity", "User")
                        .WithMany("UsersLogs")
